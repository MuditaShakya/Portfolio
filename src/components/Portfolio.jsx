    ...
    const portfolios = [
        {
            ...
            name: "Record Keeper",
            src: hms,
            liveLink: "https://your-live-demo-link-for-recordkeeper.com", // Replace with actual if available
            codeLink: "https://github.com/MuditaShakya/RecordKeeper",
        },
        {
            id: 2,
            name: "Spotify Clone",
            src: spotify,
            liveLink: "https://spotifyclone-website.netlify.app",
            codeLink: "https://github.com/MuditaShakya/SpotifyClone",
        },
        {
            id: 3,
            name: "ThriveFitness",
            src: fitness,
            liveLink: "https://thrivefitness.netlify.app",
            codeLink: "https://github.com/GunjanShakya/CollabWrite",
        },
        {
            id: 4,
            name: "InshortsClone",
            src: inshorts,
            liveLink: "https://inshortsclone-frontend.onrender.com/",
            codeLink: "https://github.com/GunjanShakya/Hackerrank_Automation",
        },
    ]
    ...
    <div name="projects" className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen">
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 px-12 sm:px-0">
                ...
                {portfolios.map(({id, name, src, liveLink, codeLink}) => (
                    <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
